#include "ADSedimentMaterialSI2.h"
#include "MooseMesh.h"

registerMooseObject("diucaApp", ADSedimentMaterialSI2);

InputParameters
ADSedimentMaterialSI2::validParams()
{
...
ADSedimentMaterialSI2::ADSedimentMaterialSI2(const InputParameters & parameters)
...
void
ADSedimentMaterialSI2::computeQpProperties()
{
