#include "ADIceMaterial_Pas.h"
#include "MooseMesh.h"

registerMooseObject("diucaApp", ADIceMaterial_Pas);

InputParameters
ADIceMaterial_Pas::validParams()
{
...
ADIceMaterial_Pas::ADIceMaterial_Pas(const InputParameters & parameters)
...
void
ADIceMaterial_Pas::computeQpProperties()
{
