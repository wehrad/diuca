...
[Problem]
  ...
  restart_file_base = icestream_3d_sedimentlayer_steady_state1_out_cp/LATEST  # You may also use a specific number here
[]

[Mesh]
  file = icestream_3d_sedimentlayer_steady_state1_out_cp/LATEST # ${initial_file}
[]
