...
/**
 * ComputeDamageWithoutStressUpdate computes the stress for a damaged elasticity material. This
 * model must be used in conjunction with a damage model (derived from DamageBase)
 */
template <bool is_ad>
class ComputeDamageWithoutStressUpdateTempl : public ComputeFiniteStrainElasticStressTempl<is_ad>
{
public:
  static InputParameters validParams();

  ComputeDamageWithoutStressUpdateTempl(const InputParameters & parameters);
...
typedef ComputeDamageWithoutStressUpdateTempl<false> ComputeDamageWithoutStressUpdate;
typedef ComputeDamageWithoutStressUpdateTempl<true> ADComputeDamageWithoutStressUpdate;
